...
namespace Library.Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClientCardTypes",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CheckoutQuantityLimit = table.Column<int>(type: "int", nullable: false),
                    CheckoutTimeLimit = table.Column<int>(type: "int", nullable: false),
                    MonthsValid = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCardTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnifiedCivilNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISO_2 = table.Column<string>(type: "nvarchar(2)", maxLength: 2, nullable: false),
                    ISO_3 = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientCardTypeId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientCards_ClientCardTypes_ClientCardTypeId",
                        column: x => x.ClientCardTypeId,
                        principalTable: "ClientCardTypes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine = table.Column<string>(type: "nvarchar(170)", maxLength: 170, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClientCardId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCardStatusChanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientCardStatusChanges_ClientCards_ClientCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenresBooks", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fines_Checkouts_CheckoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAcquisitions_BookId_Type",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientCards_ClientCardTypeId",
                table: "ClientCards",
                column: "ClientCardTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientCardStatusChanges_ClientCardId",
                table: "ClientCardStatusChanges",
                column: "ClientCardId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientCardTypes_Name",
                table: "ClientCardTypes",
                column: "Name",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Countries_ISO_2",
                table: "Countries",
                column: "ISO_2",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Countries_ISO_3",
                table: "Countries",
                column: "ISO_3",
                unique: true);
